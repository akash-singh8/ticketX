      ...
      >
        <ModalContent ref={modalRef}>
          ...
          <form  onSubmit={handleSubmit}>
            ...
            <input type="text"placeholder='Enter your mobile number*' id="username" name="username"value={formData.username}
        ...
        <div className='forgotPass'>Forgot Password?</div>
            <div className='button login-button'onClick={handleSubmit} type="submit">Login</div>
